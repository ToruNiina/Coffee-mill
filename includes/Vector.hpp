...
inline typename scalar_type_extractor<coordT>::type
...
template<typename coordT>
coordT
rotate(const typename scalar_type_extractor<coordT>::type angle,
       const coordT& axis, const coordT& target)
{
    using namespace boost::math;
    using quat = quaternion<typename scalar_type_extractor<coordT>::type>;

    const typename scalar_type_extractor<coordT>::type sin_normalize = 
